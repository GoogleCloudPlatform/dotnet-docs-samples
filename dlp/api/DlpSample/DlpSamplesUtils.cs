...
internal class DlpSamplesUtils
{
    ...
    public static IEnumerable<FieldId> ParseIdentifyingFields(string identifyingFields)
    {
    ...
    public static IEnumerable<InfoType> ParseInfoTypes(string infoTypesStr)
    {
    ...
    /// <returns>IEnumerable of FieldId items.</returns>
    public static IEnumerable<FieldId> ParseQuasiIds(string quasiIdsStr)
    {

...
namespace GoogleCloudSamples
{
    public class DlpTest
    {
        ...
        private void AssertPhoneEmailCC(ConsoleOutput output, bool checkPhone=false, bool checkEmail=false, bool checkCc=false)
        {
            var results = 0;
            if (checkPhone)
            {
        ...
        {
            AssertPhoneEmailCC(_dlp.Run(verb, _projectId, value, "-l", "4"), checkPhone: true, checkEmail: true, 
                checkCc: true);
        ...
        {
            AssertPhoneEmailCC(_dlp.Run(verb, _projectId, value, "-m", "0"), checkPhone: true, checkEmail: true, 
                checkCc: true);
            AssertPhoneEmailCC(_dlp.Run(verb, _projectId, value, "-m", "3"), checkPhone: true, checkEmail: true, 
                checkCc: true);

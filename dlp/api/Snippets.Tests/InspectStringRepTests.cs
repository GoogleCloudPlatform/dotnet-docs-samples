...
namespace GoogleCloudSamples
{
    public class InspectStringRepTests : IClassFixture<DlpTestFixture>
    {
        ...
        public void TestInspectString_CustomRegex()
        {
            ...
            var response = InspectStringRep.Inspect(Fixture.ProjectId, repLocation, testData, Likelihood.Possible.ToString(), 5, true, infoTypes, customRegex);
        ...
        public void TestInspectString_CustomDictionary()
        {
            ...
            var response = InspectStringRep.Inspect(Fixture.ProjectId, repLocation, testData, Likelihood.Possible.ToString(), 5, true, infoTypes, customDictionary);
        ...
        public void TestInspectString_CustomInfoType_NoResults()
        {
            ...
            var response = InspectStringRep.Inspect(Fixture.ProjectId, repLocation, testData, Likelihood.Possible.ToString(), 5, true, infoTypes, customInfoType);

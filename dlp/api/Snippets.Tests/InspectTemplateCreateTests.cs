...
{
    public class InspectTemplateCreateTests : IClassFixture<DlpTestFixture>
    {
        private DlpTestFixture Fixture { get; }
        public InspectTemplateCreateTests(DlpTestFixture fixture)
        {
            Fixture = fixture;
        }

        [Fact]
        public void TestInspectTemplateCreate()
        {
            ...
            try
            {
                ...
                Assert.Equal(fullName, template.Name);
            }
            finally
            {

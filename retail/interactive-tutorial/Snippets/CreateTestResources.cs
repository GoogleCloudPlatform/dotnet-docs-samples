...
public static class CreateTestResources
{
    ...
    private static readonly string productFilePath = Path.Combine(GetSolutionDirectoryFullName(), $"Snippets/resources/{ProductFileName}");
    private static readonly string eventsFilePath = Path.Combine(GetSolutionDirectoryFullName(), $"Snippets/resources/{ProductFileName}");

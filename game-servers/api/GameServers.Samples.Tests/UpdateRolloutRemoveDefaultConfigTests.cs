...
namespace GameServers.Samples.Tests
{
    ...
    public class UpdateRolloutRemoveDefaultConfigTest : IAsyncLifetime
    {
        ...
        public UpdateRolloutRemoveDefaultConfigTest(GameServersFixture fixture)
        {
            _fixture = fixture;
        ...
        [Fact]
        public async void UpdatesRolloutRemoveDefaultConfig()
        {

...
public class CreateRegionalSecretWithRotationTests
{
    private readonly RegionalSecretManagerFixture _fixture;
    private readonly CreateRegionalSecretWithRotationSample _sample;

    public CreateRegionalSecretWithRotationTests(RegionalSecretManagerFixture fixture)
    {
        _fixture = fixture;
        _sample = new CreateRegionalSecretWithRotationSample();
    }

    [Fact]
    public void CreatesRegionalSecretWithRotation()
    {
        ...
        // Run the code sample
        Secret result = _sample.CreateRegionalSecretWithRotation(

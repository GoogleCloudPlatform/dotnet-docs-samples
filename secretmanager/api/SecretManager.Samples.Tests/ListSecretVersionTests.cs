...
public class ListSecretVersionsTests
{
    private readonly SecretManagerFixture _fixture;
    private readonly ListSecretVersionsSample _sample;

    public ListSecretVersionsTests(SecretManagerFixture fixture)
    {
        _fixture = fixture;
        _sample = new ListSecretVersionsSample();
    }

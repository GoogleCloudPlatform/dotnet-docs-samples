...
public class EnableSecretVersionWithEtagSample
{
    // Synchronous version of the method
    public SecretVersion EnableSecretVersionWithEtag(
        ...
        string versionId = "1")
    {
        ...
        // Build the enable request with ETag
        ...
        SecretVersion enabledVersion = client.EnableSecretVersion(request);

        Console.WriteLine($"Enabled secret version: {enabledVersion.Name}");

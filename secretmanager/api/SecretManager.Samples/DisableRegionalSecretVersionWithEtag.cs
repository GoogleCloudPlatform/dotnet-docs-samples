...
public class DisableRegionalSecretVersionWithEtagSample
{
    public SecretVersion DisableRegionalSecretVersionWithEtag(
    ...
    )
    {
        ...
        {
            SecretVersionName = SecretVersionName.FromProjectLocationSecretSecretVersion(projectId, locationId, secretId, secretVersionId),
            Etag = etag
        };

...
public class DestroySecretVersionWithEtagSample
{
    // Synchronous version of the method
    public SecretVersion DestroySecretVersionWithEtag(
        ...
        string versionId = "1")
    {
        ...
        // Build the destroy request with ETag
        ...
        SecretVersion destroyedVersion = client.DestroySecretVersion(request);

        Console.WriteLine($"Destroyed secret version: {destroyedVersion.Name}");

...
public class DisableRegionalParamVersionTests
{
    ...
    public void DisableRegionalParamVersion()
    {
        ...
        ParameterVersion result = _sample.DisableRegionalParamVersion(projectId: parameterVersionName.ProjectId, locationId: _fixture.LocationId, parameterId: parameterVersionName.ParameterId, versionId: parameterVersionName.ParameterVersionId);

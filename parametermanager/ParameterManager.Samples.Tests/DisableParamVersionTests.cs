...
public class DisableParamVersionTests
{
    ...
    public void DisableParamVersion()
    {
        ...
        ParameterVersion result = _sample.DisableParamVersion(projectId: parameterVersionName.ProjectId, parameterId: parameterVersionName.ParameterId, versionId: parameterVersionName.ParameterVersionId);

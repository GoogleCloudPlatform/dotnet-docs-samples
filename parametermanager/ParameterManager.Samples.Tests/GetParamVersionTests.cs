...
public class GetParamVersionTests
{
    ...
    public void GetParamVersion()
    {
        ...
        ParameterVersion result = _sample.GetParamVersion(projectId: parameterVersionName.ProjectId, parameterId: parameterVersionName.ParameterId, versionId: parameterVersionName.ParameterVersionId);

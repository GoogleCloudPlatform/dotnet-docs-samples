...
namespace GoogleCloudSamples
{
    ...
    public class VisionClassificationDeployModelNodeCountTest
    {
        ...
        public VisionClassificationDeployModelNodeCountTest(AutoMLFixture fixture)
        {
            _fixture = fixture;
            _modelId = "ICN0000000000000000000";
        }
        ...
        public void TestDeployModelWithNodeCount()
        {
            ...
            try
            {
                ConsoleOutput output = _fixture.SampleRunner.Run("vision_classification_deploy_model_node_count", _fixture.ProjectId, _modelId);

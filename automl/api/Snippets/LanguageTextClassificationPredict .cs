...
{
    [Verb("language_text_classification_predict", HelpText = "Predict the text content using given model")]
    ...
    class AutoMLLanguageTextClassificationPredict
    {
        ...
        {
            verbMap.Add((LanguageTextClassificationPredictOptions opts) =>
                AutoMLLanguageTextClassificationPredict.LanguageTextClassificationPredict(
                    opts.ProjectID,
                    opts.ModelID,
                    opts.Content));
        }

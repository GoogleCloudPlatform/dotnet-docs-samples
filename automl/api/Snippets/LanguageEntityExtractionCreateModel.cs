...
{
<<<<<<< HEAD
    [Verb("create_model_language_entity_extraction", HelpText = "Create a Model for Language Entity Extraction")]
=======
...
>>>>>>> d42fde96... finished IT
    ...
    class AutoMLLanguageEntityExtractionCreateModel
    {
        ...
        public static object LanguageEntityExtractionCreateModel(string projectId = "YOUR-PROJECT-ID",
            ...
            string displayName = "YOUR_DATASET_NAME")
        {
            ...
            // Set model metadata.
            TextExtractionModelMetadata metadata = new TextExtractionModelMetadata
            {
            };
        ...
        {
            verbMap.Add((LanguageEntityExtractionCreateModelOptions opts) =>
                AutoMLLanguageEntityExtractionCreateModel.LanguageEntityExtractionCreateModel(
                    opts.ProjectID,
                    opts.DisplayName,
                    opts.DatasetID));
        }

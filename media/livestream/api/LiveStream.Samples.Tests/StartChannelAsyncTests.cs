...
namespace LiveStream.Samples.Tests
{
    ...
    public class StartChannelAsyncTest : IAsyncLifetime
    {
        ...
        public StartChannelAsyncTest(LiveStreamFixture fixture)
        {
            _fixture = fixture;
        ...
        [Fact]
        public async Task StartsChannelAsync()
        {
            ...
            Assert.Equal(_fixture.ChannelStartedState, result.StreamingState);
        }
    }
}
...
namespace Stitcher.Samples.Tests
{
    ...
    public class CreateCdnKeyAsyncTest
    {
        ...
        public CreateCdnKeyAsyncTest(StitcherFixture fixture)
        {
            ...
            _cloudCdnKeyId = $"{_fixture.CloudCdnKeyIdPrefix}-{StitcherFixture.GetRandomId()}-{StitcherFixture.GetTimestampId()}";
            _mediaCdnKeyId = $"{_fixture.MediaCdnKeyIdPrefix}-{StitcherFixture.GetRandomId()}-{StitcherFixture.GetTimestampId()}";
        }

...
namespace GoogleCloudSamples
{
    public class QuickStartJobs
    {
        ...
        public static void Main(string[] args)
        {
            ...
            Job customJob = GenerateJobWithACustomAttribute(myCompany.Name);
            customJob = CreateJob(customJob);
            Console.WriteLine("Custom attribute job created: " + customJob.Name);

            // Test get job
            Job retrievedJob = GetJob(newJob.Name);

...
public class CreateKeySymmetricEncryptDecryptTest
{
    private readonly KmsFixture _fixture;
    private readonly CreateKeySymmetricEncryptDecryptSample _sample;

    public CreateKeySymmetricEncryptDecryptTest(KmsFixture fixture)
    {
        _fixture = fixture;
        _sample = new CreateKeySymmetricEncryptDecryptSample();
    }
    ...
    {
        // Run the sample code.
        var result = _sample.CreateKeySymmetricEncryptDecrypt(

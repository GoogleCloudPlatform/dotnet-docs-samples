...
public class ExecutePartitionedDmlAsyncPostgreSample
{
    public async Task<long> ExecutePartitionedDmlAsyncPostgre(string projectId, string instanceId, string databaseId)
    {

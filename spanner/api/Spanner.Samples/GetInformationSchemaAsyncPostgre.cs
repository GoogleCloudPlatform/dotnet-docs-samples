...
public class GetInformationSchemaAsyncPostgreSample
{
    public async Task<List<InformationSchema>> GetInformationSchemaAsyncPostgre(string projectId, string instanceId, string databaseId)
    {

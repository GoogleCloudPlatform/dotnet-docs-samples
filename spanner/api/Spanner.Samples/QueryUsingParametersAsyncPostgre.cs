...
public class QueryUsingParametersAsyncPostgreSample
{
    public async Task<List<Singer>> QueryUsingParametersAsyncPostgre(string projectId, string instanceId, string databaseId)
    {

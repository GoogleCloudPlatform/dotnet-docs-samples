...
public class DeleteDataAsyncSample
{
    ...
    public async Task<int> DeleteDataAsync(string projectId, string instanceId, string databaseId)
    {
        ...
        using (var connection = new SpannerConnection(connectionString))
        {
            ...
            {
                var cmd = connection.CreateInsertCommand("UpcomingSingers", new SpannerParameterCollection
                {
            ...
            {
                var cmd = connection.CreateInsertCommand("UpcomingAlbums", new SpannerParameterCollection
                {

...
public class InsertUsingDmlReturningAsyncPostgreSample
{
    public async Task<List<string>> InsertUsingDmlReturningAsyncPostgre(string projectId, string instanceId, string databaseId)
    {

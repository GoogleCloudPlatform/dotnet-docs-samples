...
public class InsertUsingBatchDmlAsyncPostgreSample
{
    public async Task<int> InsertUsingBatchDmlAsyncPostgre(string projectId, string instanceId, string databaseId)
    {

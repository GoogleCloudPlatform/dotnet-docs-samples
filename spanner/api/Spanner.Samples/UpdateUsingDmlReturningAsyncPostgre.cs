...
public class UpdateUsingDmlReturningAsyncPostgreSample
{
    public async Task<List<long>> UpdateUsingDmlReturningAsyncPostgre(string projectId, string instanceId, string databaseId)
    {

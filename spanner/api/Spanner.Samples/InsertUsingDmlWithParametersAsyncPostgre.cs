...
public class InsertUsingDmlWithParametersAsyncPostgreSample
{
    public async Task<int> InsertUsingDmlWithParametersAsyncPostgre(string projectId, string instanceId, string databaseId)
    {

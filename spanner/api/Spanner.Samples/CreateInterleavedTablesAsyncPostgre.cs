...
public class CreateInterleavedTablesAsyncPostgreSample
{
    public async Task CreateInterleavedTablesAsyncPostgre(string projectId, string instanceId, string databaseId)
    {

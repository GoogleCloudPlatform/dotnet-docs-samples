...
public class IdentifierCaseSensitivityAsyncPostgreSample
{
    public async Task<int> IdentifierCaseSensitivityAsyncPostgre(string projectId, string instanceId, string databaseId)
    {

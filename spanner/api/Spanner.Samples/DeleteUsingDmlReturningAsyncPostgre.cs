...
public class DeleteUsingDmlReturningAsyncPostgreSample
{
    public async Task<List<string>> DeleteUsingDmlReturningAsyncPostgre(string projectId, string instanceId, string databaseId)
    {

...
public class QueryDataWithStructFieldTest
{
    private readonly SpannerFixture _spannerFixture;

    public QueryDataWithStructFieldTest(SpannerFixture spannerFixture)
    {
        _spannerFixture = spannerFixture;
    }

    [Fact]
    public async void TestQueryDataWithStructField()
    {

...
public class UpdateUsingDmlWithStructCoreTest
{
    private readonly SpannerFixture _spannerFixture;

    public UpdateUsingDmlWithStructCoreTest(SpannerFixture spannerFixture)
    {
        _spannerFixture = spannerFixture;
    }

    [Fact]
    public async void TestUpdateUsingDmlWithStructCore()
    {

...
public class UpdateUsingDmlWithTimestampCoreTest
{
    private readonly SpannerFixture _spannerFixture;

    public UpdateUsingDmlWithTimestampCoreTest(SpannerFixture spannerFixture)
    {
        _spannerFixture = spannerFixture;
    }

    [Fact]
    public async void TestUpdateUsingDmlWithTimestampCore()
    {

...
public class ReadWriteWithTransactionTest
{
    private readonly SpannerFixture _spannerFixture;

    public ReadWriteWithTransactionTest(SpannerFixture spannerFixture)
    {
        _spannerFixture = spannerFixture;
    }

    [Fact]
    public async void TestReadWriteWithTransaction()
    {

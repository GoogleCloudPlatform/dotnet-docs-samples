...
public class QueryDataWithTimestampColumnTest
{
    private readonly SpannerFixture _spannerFixture;

    public QueryDataWithTimestampColumnTest(SpannerFixture spannerFixture)
    {
        _spannerFixture = spannerFixture;
    }

    [Fact]
    public async void TestQueryDataWithTimestampColumn()
    {

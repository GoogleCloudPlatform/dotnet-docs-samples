...
public class CreateConnectionWithQueryOptionsTest
{
    private readonly SpannerFixture _spannerFixture;

    public CreateConnectionWithQueryOptionsTest(SpannerFixture spannerFixture)
    {
        _spannerFixture = spannerFixture;
    }

    [Fact]
    public async void TestCreateConnectionWithQueryOptions()
    {

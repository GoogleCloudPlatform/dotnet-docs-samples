...
public class ReadWriteWithTransactionCoreTest
{
    private readonly SpannerFixture _spannerFixture;

    public ReadWriteWithTransactionCoreTest(SpannerFixture spannerFixture)
    {
        _spannerFixture = spannerFixture;
    }

    [Fact]
    public async void TestReadWriteWithTransactionCore()
    {

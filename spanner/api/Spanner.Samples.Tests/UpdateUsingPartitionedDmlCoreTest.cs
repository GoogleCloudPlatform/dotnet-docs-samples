...
public class UpdateUsingPartitionedDmlCoreTest
{
    private readonly SpannerFixture _spannerFixture;

    public UpdateUsingPartitionedDmlCoreTest(SpannerFixture spannerFixture)
    {
        _spannerFixture = spannerFixture;
    }

    [Fact]
    public async void TestUpdateUsingPartitionedDmlCore()
    {

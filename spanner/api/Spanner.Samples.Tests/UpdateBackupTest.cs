...
public class UpdateBackupTest
{
    ...
    public void TestUpdateBackup()
    {
        ...
        var backups = getBackupsSample.GetBackups(_spannerFixture.ProjectId, _spannerFixture.InstanceId, _spannerFixture.DatabaseId, _spannerFixture.BackupId).ToList(); var updatedBackup = updateBackupSample.UpdateBackup(_spannerFixture.ProjectId, _spannerFixture.InstanceId, _spannerFixture.BackupId);

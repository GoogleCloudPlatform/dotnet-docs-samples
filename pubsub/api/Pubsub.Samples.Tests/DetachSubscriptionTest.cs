...
public class DetachSubscriptionTest
{
    private readonly PubsubFixture _pubsubFixture;
    private readonly DetachSubscriptionSample _detachSubscriptionSample;

    public DetachSubscriptionTest(PubsubFixture pubsubFixture)
    {
        _pubsubFixture = pubsubFixture;
        _detachSubscriptionSample = new DetachSubscriptionSample();
    }

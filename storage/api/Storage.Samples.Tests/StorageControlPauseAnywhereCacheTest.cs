...
public class StorageControlPauseAnywhereCacheTest
{
    private readonly StorageFixture _fixture;

    public StorageControlPauseAnywhereCacheTest(StorageFixture fixture)
    {
        _fixture = fixture;
    }

    [Fact]
    public void TestStorageControlPauseAnywhereCache()
    {
        ...
        Assert.Equal("paused", pausedCache.State);
    }
}

...
public class CreateBucketWithObjectRetentionTest
{
    private readonly StorageFixture _fixture;

    public CreateBucketWithObjectRetentionTest(StorageFixture fixture)
    {
        _fixture = fixture;
    }
    ...
    public void CreateBucketWithObjectRetention()
    {

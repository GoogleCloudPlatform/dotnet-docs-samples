...
namespace Compute.Samples.Tests
{
    ...
    public class ListAllInstancesAsyncTest
    {
        ...
        private readonly ListAllInstancesAsyncSample _listSample = new ListAllInstancesAsyncSample();
        ...
        public async Task ListsInstance()
        {
            ...
            var instances = await _listSample.ListAllInstancesAsync(_fixture.ProjectId);

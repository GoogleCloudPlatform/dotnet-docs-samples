...
public class ImportEntitiesTest
{
    ...
    public void TestImportEntities()
    {
        ...
        var outputUrl = exportEntitiesSample.ExportEntities(_datastoreAdminFixture.ProjectId, $"gs://{_datastoreAdminFixture.BucketName}", _datastoreAdminFixture.Kind);
        var isCompleted = importEntitiesSample.ImportEntities(_datastoreAdminFixture.ProjectId, outputUrl, _datastoreAdminFixture.Kind);

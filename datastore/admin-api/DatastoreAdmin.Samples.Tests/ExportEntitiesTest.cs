...
public class ExportEntitiesTest
{
    private readonly DatastoreAdminFixture _datastoreAdminFixture;

    public ExportEntitiesTest(DatastoreAdminFixture datastoreAdminFixture)
    {
    ...
    public void TestExportEntities()
    {
        ...
        var outputUrl = exportEntitiesSample.ExportEntities(
            _datastoreAdminFixture.ProjectId, $"gs://{_datastoreAdminFixture.BucketName}", _datastoreAdminFixture.Kind);

...
{
    public IEnumerable<Index> ListIndexes(string projectId, string filter = "")
    {
        // Create client
        ...
        PagedEnumerable<ListIndexesResponse, Index> response = datastoreAdminClient.ListIndexes(listIndexesRequest);

        foreach (Index index in response)
        {

...
public class DeleteInventoryReportConfigTest
{
    ...
    public void TestDeleteInventoryReportConfig()
    {
        ...
        sample.DeleteInventoryReportConfig(_fixture.ProjectId, _fixture.BucketLocation, reportConfig.Name.Split("/")[5]);

        foreach(ReportConfig report in _fixture.StorageInsights.ListReportConfigs(LocationName.Format(_fixture.ProjectId, _fixture.BucketLocation)))
        {

...
public class FilterLimitColQualifierRegexAsyncSample
{
    public async Task<List<Row>> FilterLimitColQualifierRegexAsync(string projectId, string instanceId, string tableId)
    {

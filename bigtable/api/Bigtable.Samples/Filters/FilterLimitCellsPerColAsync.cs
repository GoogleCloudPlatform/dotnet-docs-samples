...
public class FilterLimitCellsPerColAsyncSample
{
    /// <summary>
    ...
    public async Task<List<Row>> FilterLimitCellsPerColAsync(string projectId, string instanceId, string tableId)
    {

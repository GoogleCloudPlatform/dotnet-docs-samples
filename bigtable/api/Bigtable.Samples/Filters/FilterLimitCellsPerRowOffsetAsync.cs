...
public class FilterLimitCellsPerRowOffsetAsyncSample
{
    public async Task<List<Row>> FilterLimitCellsPerRowOffsetAsync(string projectId, string instanceId, string tableId)
    {

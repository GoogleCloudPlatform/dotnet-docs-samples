...
public class FilterModifyApplyLabelAsyncSample
{
    public async Task<List<Row>> FilterModifyApplyLabelAsync(string projectId, string instanceId, string tableId)
    {

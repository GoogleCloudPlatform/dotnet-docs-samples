...
public class FilterModifyStripValueAsyncSample
{
    public async Task<List<Row>> FilterModifyStripValueAsync(string projectId, string instanceId, string tableId)
    {

...
public class FilterLimitCellsPerRowAsyncSample
{
    /// <summary>
    ...
    public async Task<List<Row>> FilterLimitCellsPerRowAsync(string projectId, string instanceId, string tableId)
    {

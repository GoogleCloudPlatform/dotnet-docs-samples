...
namespace Filters
{
    public class FilterLimitValueRegex
    {
        /// <summary>
        ...
        public static Task<string> BigtableFilterLimitValueRegex(string projectId = "YOUR-PROJECT-ID", string instanceId = "YOUR-INSTANCE-ID", string tableId = "YOUR-TABLE-ID")
        {

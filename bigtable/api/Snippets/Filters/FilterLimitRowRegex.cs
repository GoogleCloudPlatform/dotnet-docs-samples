...
namespace Filters
{
    public class FilterLimitRowRegex
    {
        /// <summary>
        ...
        public static Task<string> BigtableFilterLimitRowRegex(string projectId = "YOUR-PROJECT-ID", string instanceId = "YOUR-INSTANCE-ID", string tableId = "YOUR-TABLE-ID")
        {

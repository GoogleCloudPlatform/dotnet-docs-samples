...
{
    public static int DoHelloWorld(string projectId, string instanceId, string tableId)
    {
        try
        {
            // The name of a column family.
            const string columnFamily = "cf";
            // The name of a culomn inside the column family.
            const string columnName = "greeting";
            // Some friendly greetings to write to Cloud Bigtable
            string[] s_greetings = { "Hello World!", "Hello Bigtable!", "Hello C#!" };
            // This List contains mapping indices from MutateRowsRequest to s_greetings[].
            List<int> s_mapToOriginalGreetingIndex;
            const string rowKeyPrefix = "greeting";
            int s_greetingIndex;
            ...
            if (!TableExist(bigtableTableAdminClient, projectId, instanceId, tableId))
            {
                ...
                Console.WriteLine(TableExist(bigtableTableAdminClient, projectId, instanceId, tableId)
    ...
    private static bool TableExist(BigtableTableAdminClient bigtableTableAdminClient, string projectId, string instanceId, string tableId)
    {

...
public class MultiTurnChatSampleTest
{
    private readonly AIPlatformFixture _fixture;
    private readonly MultiTurnChatSample _sample;

    public MultiTurnChatSampleTest(AIPlatformFixture fixture)
    {
        _fixture = fixture;
        _sample = new MultiTurnChatSample();
    }

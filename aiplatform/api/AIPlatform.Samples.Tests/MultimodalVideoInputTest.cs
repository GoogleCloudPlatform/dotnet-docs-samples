...
public class MultimodalVideoInputTest
{
    private readonly AIPlatformFixture _fixture;
    private readonly MultimodalVideoInput _sample;

    public MultimodalVideoInputTest(AIPlatformFixture fixture)
    {
        _fixture = fixture;
        _sample = new MultimodalVideoInput();
    }

...
public class VideoInputWithAudioTest
{
    private readonly AIPlatformFixture _fixture;
    private readonly VideoInputWithAudio _sample;

    public VideoInputWithAudioTest(AIPlatformFixture fixture)
    {
        _fixture = fixture;
        _sample = new VideoInputWithAudio();
    }

...
public class GeminiQuickstartTest
{
    private readonly AIPlatformFixture _fixture;
    private readonly GeminiQuickstart _sample;

    public GeminiQuickstartTest(AIPlatformFixture fixture)
    {
        _fixture = fixture;
        _sample = new GeminiQuickstart();
    }

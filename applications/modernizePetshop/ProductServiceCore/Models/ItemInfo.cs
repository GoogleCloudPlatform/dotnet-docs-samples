...
namespace PetProduct.Models
{
    ...
    public class ItemInfo
    {
        ...
        public ItemInfo(string id, string name, string quantity, string price, string productName, string image, string categoryId, string productId)
        {
            this.id = id;
            this.name = name;

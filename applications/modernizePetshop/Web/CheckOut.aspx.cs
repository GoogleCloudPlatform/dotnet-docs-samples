    ...
    public partial class CheckOut : System.Web.UI.Page {
        ...
        protected void wzdCheckOut_FinishButtonClick(object sender, WizardNavigationEventArgs e) {
            if (Profile.ShoppingCart.CartItems.Count > 0) {
                ...
                lblMsg.Text = "<p><br>Can not process the order. <h3>Your cart is empty, please continue shopping before checking out.</h3></p><br><br><p class=SignUpLabel><a class=linkNewUser href=Default.aspx>Continue shopping</a></p>";
